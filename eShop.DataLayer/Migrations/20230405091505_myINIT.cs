        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderProduct_Products_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderCustomer_Customers_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Customers",
                        principalColumn: "CustomerID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderCustomer_Orders_CustomerId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "this game is awesome", 1, "Blizzard", 1.0, 100, "Game" },
                    { 2, "this game is awesome", 2, "Blizzard", 2.0, 100, "Game" },
                    { 3, "this game is awesome", 3, "Blizzard", 3.0, 100, "Game" },
                    { 4, "this game is awesome", 4, "Blizzard", 4.0, 100, "Game" },
                    { 5, "this game is awesome", 5, "Blizzard", 5.0, 100, "Game" },
                    { 6, "this game is awesome", 6, "Blizzard", 6.0, 100, "Game" },
                    { 7, "this game is awesome", 7, "Blizzard", 7.0, 100, "Game" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Image not load", "~\\wwwroot\\Images\\DefaultImg.png", 1 },
                    { 2, "Image not load", "~\\wwwroot\\Images\\DefaultImg.png", 2 },
                    { 3, "Image not load", "~\\wwwroot\\Images\\DefaultImg.png", 3 },
                    { 4, "Image not load", "~\\wwwroot\\Images\\DefaultImg.png", 4 },
                    { 5, "Image not load", "~\\wwwroot\\Images\\DefaultImg.png", 5 },
                    { 6, "Image not load", "~\\wwwroot\\Images\\DefaultImg.png", 6 },
                    { 7, "Image not load", "~\\wwwroot\\Images\\DefaultImg.png", 7 }
                });
